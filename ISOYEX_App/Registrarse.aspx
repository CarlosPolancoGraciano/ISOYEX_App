    ...
    <form>
        <div class="p-4 m-4">
            <div class="text-center">
                <h1 class="display-4">Tipo de Registro</h1>
            </div>
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                <label class="btn btn-light">
                    <input type="radio" name="options" id="initialChecked" value="ind">
                    Individuo
                </label>
                <label class="btn btn-light">
            ...
            <div class="card-body">
                <div class="container AllControl">
                    ...
                    <div class="row text-center col-md-6">
                        <asp:Button ID="btnRegistrarse" class="btn btn-success AllControl" runat="server" Text="Registrarme" OnClick="btnRegistrarse_Click" />
